...
// NOTE: Cart is intentionally NOT a JPA @Entity — it is a transient/session-scoped
// in-memory object. There is no corresponding table in the database.
// If you want to persist carts, you will need to add a DB table and JPA annotations.
public class Cart {
